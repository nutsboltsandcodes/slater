	    ...
	    <div class="comments__inner-container">
	      ...
	      <ul class="comment-list">
	    	...
	    	<?php $comments_args = array(
				        ...
				        'comment_field' => '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'none', 'slater' ) . '</label><textarea id="comment" name="comment" aria-required="true"></textarea></p>',
				);
